...
static void sub_scheduler_init();
static void run_sub_task(char *t_arg);
...
static void *sub_scheduler_server(void *tt_arg)
{
...
static void sub_scheduler_init(char *t_arg)
{
	char *parameter;
	char *save_ptr;
	int i;
...
static void run_sub_task(char *i_arg)
{
	char file_path[64];
	char **arg;
	char *t_arg;
